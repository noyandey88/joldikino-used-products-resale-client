      ...
      <section>
        <div className="container flex flex-col items-center justify-center min-h-screen px-6 mx-auto">
          <form onSubmit={handleSubmit(handleLogin)} className="w-full max-w-md">
            <h1 className="text-3xl font-semibold text-gray-800 capitalize">Login</h1>
            ...
            <div className="relative flex items-center mt-8">
              ...
              <input {...register("email", {
                ...
                type="email" className="block w-full py-3 border rounded-md px-11 focus:border-blue-400 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Email address" />
            </div>
