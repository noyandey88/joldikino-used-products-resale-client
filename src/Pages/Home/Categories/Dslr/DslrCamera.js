            ...
            <>
              {
                ...
                <div className="grid grid-cols-2 gap-4 items-center">
                  {
                    stock !== 'booked' ?
                      <label onClick={() => setDslrCamera(camera)} className="btn mt-2 bg-green-500 hover:bg-green-600 border-0" htmlFor="book-product">Book</label>
                      :
                      <button className="mt-2 btn btn-disabled text-gray-200 bg-green-500 hover:bg-green-600 border-0">Booked</button>
                  }
                  {/* <button className="btn btn-primary mt-2">Book</button> */}
                  {
                    status !== 'reported' ?
                      ...
                      :
                      <button className="mt-2 btn btn-disabled text-gray-200 bg-green-500 hover:bg-green-600 border-0">Reported</button>
                  }
                </div>
              }
            </>
