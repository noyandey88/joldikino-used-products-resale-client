            ...
            <>
              {
                ...
                <div className="grid grid-cols-2 gap-4 items-center">
                  {
                    stock !== 'booked' ?
                      <label onClick={() => setActionCamera(camera)} className="btn mt-2 bg-green-500 hover:bg-green-600 border-0" htmlFor="book-product">Book</label>
                      :
                      <button className="mt-2 btn bg-green-500 hover:bg-green-600 border-0 text-gray-200 btn-disabled">Booked</button>
                  }
