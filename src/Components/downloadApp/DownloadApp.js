    ...
    <div className="px-4 py-4 mx-auto mt-8 sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-24">
      <div className="max-w-lg sm:text-center sm:mx-auto">
        <motion.h2
          ...
          viewport={{ once: true }}
          className="mb-6 text-center text-xl md:text-3xl font-bold tracking-tight text-gray-900 sm:text-3xl sm:leading-none">
          Download our mobile app
        </motion.h2>
        <motion.div
          initial={{ y: 50 }}
          whileInView={{ y: 0 }}
          transition={{ type: "spring", stiffness: 40, duration: 1, ease: "easeInOut", bounce: 0.3 }}
          viewport={{ once: true }}
        ...
        <motion.p
          ...
          viewport={{ once: true }}
          className="max-w-xs text-xs text-gray-600 sm:text-sm sm:max-w-sm sm:mx-auto text-center">
